...
$$
\begin{align*}
\{ \boldsymbol{x} | \boldsymbol{a}_j^\top \boldsymbol{x} \leq b_j, j = 1, \dots, r \}
\end{align*}
$$
...
$$
\begin{align*}
\{ \boldsymbol{x} | \boldsymbol{a}_j^\top \boldsymbol{x} \leq 0, j = 1, \dots, r \}
\end{align*}
$$
...
$$
\begin{align*}
epi(f) = \{ (\boldsymbol{x}, w) | \boldsymbol{x} \in X, w \in \mathbb{R}, f(\boldsymbol{x}) \leq w \}
\end{align*}
$$
...
$$
\begin{align*}f
(\boldsymbol{x}bar) > \liminf_{k \rightarrow \infty} f(\boldsymbol{x}_k)
\end{align*}
$$
